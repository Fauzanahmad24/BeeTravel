...
namespace Revisi
{
    public partial class Bus : Form
    {
        ...
        {
            if (cmb_kasal.Text == "" || cmb_ktujuan.Text == "" || cmb_jum_penum.Text == "" || cmb_kelasbus.Text == "" || cmb_penumpang.Text == "" || dtp_tanggal.Text == "")
            {
        ...
        public void cmb_ktujuan_SelectedIndexChanged(object sender, EventArgs e)
        {
        }
            ...
            try
            {
                ...
                else
                {
                    if (cmb_kelasbus.Text == "Bisnis")
                    {
                        ...
                        {
                            tarif.Text = "";
                            MessageBox.Show("Bus tidak tersedia");
                        }
                    }
                    else if (cmb_kelasbus.Text == "Ekonomi")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 80000;
                    ...
                    else if (cmb_kelasbus.Text == "Eksekutif")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 800000;
