...
namespace Revisi
{
    public partial class Kapal : Form
    {
        public Kapal()
        {
            InitializeComponent();
        ...
        private void Kapal_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    if (cmb_kelaskapal.Text == "Bisnis")
                    {
                        ...
                        {
                            tarif.Text = "";
                            MessageBox.Show("kapal tidak tersedia");
                        }
                    }
                    else if (cmb_kelaskapal.Text == "Ekonomi")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 80000;
                    ...
                    else if (cmb_kelaskapal.Text == "Eksekutif")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 800000;
                    ...
                    {
                        tarif.Text = "";
                        MessageBox.Show("Pilih kelas kapal !!!");
                    }
                }
            }
            catch (Exception)
        ...
        {
            if (cmb_kasal.Text == "" || cmb_ktujuan.Text == "" || cmb_jum_penum.Text == "" || cmb_kelaskapal.Text == "" || cmb_penumpang.Text == "" || dtp_tanggal.Text == "")
            {
                MessageBox.Show("Lengkapi Data Anda");
            }
            else
