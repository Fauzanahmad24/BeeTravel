    ...
    public partial class Pesawat : Form
    {
        ...
        private void btn_cek_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (cmb_kelaspenerbangan.Text == "Bisnis")
                    {
                        ...
                        {
                            tarif.Text = "";
                            MessageBox.Show("Pesawat tidak tersedia");
                        }
                    }
                    else if (cmb_kelaspenerbangan.Text == "Ekonomi")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 80000;
                    ...
                    else if (cmb_kelaspenerbangan.Text == "Eksekutif")
                    {
                        if (cmb_kasal.Text == "makassar" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "jakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "semarang" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "yogyakarta" && cmb_ktujuan.Text == "palu" || cmb_kasal.Text == "medan" && cmb_ktujuan.Text == "palu")
                        {
                            int h = 800000;
        ...
        {
            if (cmb_kasal.Text == "" || cmb_ktujuan.Text == "" || cmb_jum_penum.Text == "" || cmb_kelaspenerbangan.Text == "" || cmb_penumpang.Text == "" || dtp_tanggal.Text == "")
            {
                MessageBox.Show("Lengkapi Data Anda");
            }
            else
